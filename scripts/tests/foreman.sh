...
set_newman_password "foreman_provision.json" "$ADMIN_PASSWORD"
set_newman_password "foreman_cleanup.json" "$ADMIN_PASSWORD"
set_newman_password "foreman_after_agent_run.json" "$ADMIN_PASSWORD"
